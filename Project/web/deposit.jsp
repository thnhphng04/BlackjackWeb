<%-- 
    Document   : deposit
    Created on : Mar 10, 2024, 1:02:57 PM
    Author     : DELL
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function doDelete(id) {
                if (confirm("Bạn có chắc muốn xóa lịch nạp chơi với ID = " + id)) {
                    window.location = "deletetran?id=" + id + "&user=${sessionScope.player.username}" + "&type=deposit" +"#lsnr";
                }
            }
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            ...
                            <form id="cochang" class="form_main" action="deposit?user=${sessionScope.player.username}" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        Số tiền nạp: <input class="form_control" type="number" name="depositMoney">Đơn vị: $
                                    </div>
